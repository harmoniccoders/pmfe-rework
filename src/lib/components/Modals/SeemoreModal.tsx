              ...
              <Flex w="100%" flexDirection="column">
                ...
                <Box my="30px" bg="blue.50" borderRadius="5px" p="1rem">
                  ...
                  <Text fontSize="13px" lineHeight={1.5} textAlign="justify">
                    ...
                    maintained by
                    <strong> {item.createdByUser?.fullName} </strong>.
                    PropertyMataaz shall not in any way be held liable for the
                    actions of any agent and/or property owner/landlord with
                    respect to this property on or off this web application,
                    website or App.
                  </Text>
                </Box>
              </Flex>
