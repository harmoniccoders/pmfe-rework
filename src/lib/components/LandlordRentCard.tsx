import { Grid, Text, Divider,HStack, Box, Button } from '@chakra-ui/react';
...
const LandlordRentCard = () =>{
    return(
        ...
        boxShadow="0 23px 36px 4px rgba(0,0,0,0.14)" p='1.2rem' minH='150px'>
            ...
            <Button border='1px solid gray' color='gray' bg='#fff !important' mt='.5rem' mb='.75rem' cursor='pointer' w={['90%','']} >View Details</Button>
        </Box>
        </>
    );
};
